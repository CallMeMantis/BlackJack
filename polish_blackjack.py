        ...
        while self.player_money > 0 and self.want_to_play == True:
            ...
            while game.is_finished() != False:
                ...
                if player == "yes":
                    ...
                    self.cards = self.player.return_data()[0]
                    self.player_points = self.player.return_data()[1]
                    self.aces_user = self.player.return_data()[2]
                    self.used_cards_player = self.player.return_data()[3]
                    self.player_money = self.player.return_data()[4]
