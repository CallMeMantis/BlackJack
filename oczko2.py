...
class Deck:
    ...
    def shuffle(self):
        ...
        #     a = rd.randint(0,len(self.cards) - 1)
        #     self.cards[a] = self.cards_copy[i]
        #     # self.index[a] = self.index_copy[i]
...
class Game:
    ...
    def main_game(self):
        ...
        if player == "yes":
            self.id = rd.randint(0,len(self.cards) - 1)   #    ----------------- Dlaczego czasami error z indeksem?
    ...
    def is_finished(self):
        if self.player_points == 21:
            ...
            print()
            player_money = self.player_money + self.cash_rate
...
while player_money > 0:   # dopoki nie skoncza sie pieniadze
    if iteration == 0:     # aby karty startowe zadeklarowac tylko za pierwszym razem
        game.deck()
    game.shuffle()
    print("################################")
    ...
    while game.is_finished() != False:
        game.main_game()
    player_money = game.is_finished()[1]
    game.reset_points()
    iteration = 1
